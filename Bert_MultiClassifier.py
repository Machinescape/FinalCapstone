...
FLAGS.bert_hub_module_handle = 'https://tfhub.dev/google/bert_cased_L-12_H-768_A-12/1'
...
def train_classifier():
    ...
    file_based_convert_examples_to_features(
            train_examples, MAX_SEQ_LENGTH, tokenizer1, train_file)
...
def eval_classifier():
    ...
    file_based_convert_examples_to_features(
    eval_examples, MAX_SEQ_LENGTH, tokenizer1, eval_file)
...
def test_classifier():
    ...
    test_features = convert_examples_to_features(predict_examples, MAX_SEQ_LENGTH, tokenizer1)
